...
def find_sub_clusters_spectral(all_raw_weighted_edges, main_clusters, 
    ...
    for original_cluster_idx, main_cluster_nodes in enumerate(main_clusters):
        ...
        while True:
            ...
            try:
                labels = SpectralClustering(n_clusters=k, affinity='precomputed', n_init=10, assign_labels='kmeans', random_state=0, eigen_solver="amg").fit_predict(adj_matrix)
